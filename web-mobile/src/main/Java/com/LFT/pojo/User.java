...
public class User {
     ...
     * 获取用户推荐存粮数
     *
     * @return user_recommend - 用户推荐存粮数
     */
    public Double getUserRecommend() {
     ...
     * 设置用户推荐存粮数
     *
     * @param userRecommend 用户推荐存粮数
     */
    public void setUserRecommend(Double userRecommend) {
